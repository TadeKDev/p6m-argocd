...
const list: {
...
}[] = [
  {
    ...
    link: "https://twitter.com/scott_persinger",
  ...
  },
  {
    ...
    link: "https://www.producthunt.com/products/Supercog-2/reviews?review=667971",
  },
  {
    name: "Sean",
  ...
  },
  {
    ...
    type: refTypes.productHunt,
    link: "https://www.producthunt.com/posts/Supercog-2?comment=2707061",
  },
  {
    username: "imgyf",
    name: "Yifan Goh",
  ...
  {
    name: "Yazdun",
    text: "Yo Scott, I got the boilerplate, it's fantastic man you just save me 10 hours on each project",
    type: refTypes.other,
  },
  {
    name: "Scott Lou",
    text: "The tool is exactly what I didn't even know I needed.",
    videoPoster: "https://d1wkquwg5s1b04.cloudfront.net/demo/scottPoster.jpg",
    videoSrc: "https://d1wkquwg5s1b04.cloudfront.net/demo/scottVideo.mp4",
    videoHeight: 250,
    videoWidth: 500,
    type: refTypes.video,
  },
  ...
  },
  {
    ...
    type: refTypes.productHunt,
    link: "https://www.producthunt.com/posts/Supercog-2?comment=2706763",
  },
  // The last testimonial is featured on big devices (span 2 columns + big font) 👇
  {
    username: "VicPivots",
    name: "Victor Abeledo",
    text: "Scott, I got your boilerplate and having the payments setup with Stripe + user auth is a blessing. This will save me like a week of work for each new side project I spin up. I appreciate that is well documented, as well. 100% worth it 🚀🚀🚀",
    type: refTypes.twitter,
