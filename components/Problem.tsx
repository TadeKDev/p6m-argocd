...
// For instance:
// - Hero: "Supercog helps developers launch startups fast"
// - Problem Agitation: "Developers spend too much time adding features, get overwhelmed, and quit." (not about Supercog at all)
// - Features: "Supercog has user auth, Stripe, emails all set up for you"
const Problem = () => {
  return (
