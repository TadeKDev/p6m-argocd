    ...
    <>
      ...
      <main className="mx-auto min-h-screen max-w-7xl space-y-8 px-4 py-12 xl:px-0">
        <h1 className="text-3xl font-extrabold">
          Privacy Policy for {config.appName}, Inc.
        </h1>
        <article className="prose prose-sm max-w-none">
          <p>
            {config.appName}, Inc (the “Company”) is committed to maintaining
          ...
          <p>
            ...
            website, which can be accessed at {config.domainName}.
          </p>
          <p>
            “Service” refers to the Company’s services accessed via the Site, in
            which users can connect with various tools and then build
            large-language model agents to autonomously interact with those
            tools.
          </p>
          ...
          <p>
            ...
            and <a href="/terms-of-use">Terms of Use</a>, and you consent to our
          ...
          <p>
            ...
            Personal Information includes your email, name, and company name,
          ...
          <p>
            ...
            track information provided to us by your browser or by our software
          ...
          <p>
            ...
            such information, please contact us at {config.mailgun.supportEmail}
            .
          </p>
          ...
          <p>
            ...
            you indicate by unsubscribing, we may continue to send you
          ...
          <p>
            Last Updated: This Privacy Policy was last updated on September 5,
            2024.
          </p>
        </article>
      </main>
